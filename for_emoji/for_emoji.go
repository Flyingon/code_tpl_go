...
var emojiRx *regexp.Regexp

func init() {
	emojiRx = regexp.MustCompile(emojiReg)
}

// EmojiClean
func EmojiClean(data string) (ret string) {
	ret = emojiRx.ReplaceAllString(data, "")
	return
}
